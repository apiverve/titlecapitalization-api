# Title Case Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:titlecapitalization-api:1.1.12'
}
```
...
```java
import com.apiverve.titlecapitalization.TitleCaseConverterAPIClient;
import com.apiverve.titlecapitalization.APIResponse;
import com.apiverve.titlecapitalization.APIException;

// Initialize the client
TitleCaseConverterAPIClient client = new TitleCaseConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/titlecapitalization](https://docs.apiverve.com/ref/titlecapitalization)
...
- **Documentation:** [https://docs.apiverve.com/ref/titlecapitalization](https://docs.apiverve.com/ref/titlecapitalization)
- **Issues:** [GitHub Issues](https://github.com/apiverve/titlecapitalization-api/issues)
