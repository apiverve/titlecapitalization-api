...
{
    class TitleCaseConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/titlecapitalization";

        /// <summary>
        /// Make a POST request to the Title Case Converter API
        /// </summary>
        static async Task<JsonDocument> CallTitleCaseConverterAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;comprehensive analysis of quarterly financial performance and strategic initiatives for sustainable growth&quot;, style &#x3D; &quot;title-case&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Title Case Converter API...\n");

            var result = await CallTitleCaseConverterAPI();
