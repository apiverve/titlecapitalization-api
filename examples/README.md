# Title Case Converter API - Examples

This folder contains example code for using the Title Case Converter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/titlecapitalization',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/titlecapitalization");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/titlecapitalization](https://docs.apiverve.com/ref/titlecapitalization)
